# Consumer usage profiles (reference)

| Profile label | Typical data | Voice | SMS | Roaming | Notes |
|-----------|-------------|-------|-----|---------|-------|
| **Streaming & data-heavy** | High (60–150 GB) | Low–medium | Low | Low–medium | Video, social, home Wi-Fi offloading |
...
- **Voice decline** — negative voice trend; legacy voice bundle may be oversized
- **Roaming-heavy** — high roaming days vs low domestic roaming need in archetype

Legacy names (`Streamer`, `Chatterbox`, `Essential`, `Roamer`, `Messenger`) remain in rule-mode scoring and tests, but ML/runtime taxonomy uses the labels above.
